...
function Schedules() {
 ...
 <div className="px-6 py-4 border-b border-[#E2E8F0] flex justify-between items-center bg-[#F8FAFC]">
 <div>
 <h2 className="text-[18px] font-semibold text-[#1E3A5F]">Shift Schedules</h2>
...
export default function App() {
 ...
 <Route index element={<ClientContracts user={user} />} />
 <Route path="map" element={<div className="p-6 h-[calc(100vh-120px)]"><MapControl user={user} /></div>} />
